...
(function( root, factory ) {
    ...
    define('base',[
        ...
        return {
             ...
             * 实现类与类之间的继承。
             * @method inherits
             * @grammar User.inherits( super ) => child
             * @grammar User.inherits( super, protos ) => child
             * @grammar User.inherits( super, protos, statics ) => child
             ...
             * };
             *
             * var Manager = User.inherits( Person, {
             *     world: function() {
             *         console.log( 'World' );
             *     }
             * });
             ...
             * @grammar User.bindFn( fn, context ) => Function
             * @method bindFn
             * @example
             ...
             *         name: 'Object Name'
             *     },
             *     aliasFn = User.bind( doSomething, obj );
             *
             *  aliasFn();    // => Object Name
             *
             */
            ...
            /**
             * 引用Console.log如果存在的话，否则引用一个[空函数loop](#WebUploader:User.log)。
             * @grammar User.log( args... ) => undefined
             * @method log
             */
            log: (function() {
                if ( window.console ) {
             ...
             * 将用来将非数组对象转化成数组对象。
             * @grammar User.slice( target, start[, end] ) => Array
             * @method slice
             * @example
             * function doSomthing() {
             *     var args = User.slice( arguments, 1 );
             *     console.log( args );
             * }
             *
             ...
             * 生成唯一的ID
             * @method guid
             * @grammar User.guid() => String
             * @grammar User.guid( prefx ) => String
             */
            guid: (function() {
                var counter = 0;
             ...
             * 格式化文件大小, 输出成带单位的字符串
             * @method formatSize
             * @grammar User.formatSize( size ) => String
             * @grammar User.formatSize( size, pointLength ) => String
             * @grammar User.formatSize( size, pointLength, units ) => String
             * @param {Number} size 文件大小
             * @param {Number} [pointLength=2] 精确到的小数点数。
             * @param {Array} [units=[ 'B', 'K', 'M', 'G', 'TB' ]] 单位数组。从字节，到千字节，一直往上指定。如果单位数组里面只指定了到了K(千字节)，同时文件大小大于M, 此方法的输出将还是显示成多少K.
             * @example
             * console.log( User.formatSize( 100 ) );    // => 100B
             * console.log( User.formatSize( 1024 ) );    // => 1.00K
             * console.log( User.formatSize( 1024, 0 ) );    // => 1K
             * console.log( User.formatSize( 1024 * 1024 ) );    // => 1.00M
             * console.log( User.formatSize( 1024 * 1024 * 1024 ) );    // => 1.00G
             * console.log( User.formatSize( 1024 * 1024 * 1024, 0, ['B', 'KB', 'MB'] ) );    // => 1024MB
             */
    ...
    define('uploader',[
         ...
         * @class Base
         * @static
         * @grammar User.create( opts ) => Uploader
         */
    ...
    define('runtime/html5/imagemeta/exif',[
        ...
        //         User.log('Invalid Exif data: Invalid thumbnail data.');
        //         return;
        //     }
        //     hexData = [];
        //     for (i = 0; i < length; i += 1) {
