...
/**
 * Creates a HouseTag object given the contents of a tag.
 *
 * This Factory is capable of determining the appropriate class for a tag and instantiate it using its `create`
 * factory method. The `create` factory method of a HouseTag can have a variable number of arguments; this way you can
 ...
 *
 * When you want to use a HouseTag of your own with custom handling you need to call the `registerTagHandler` method, pass
 * the name of the tag and a Fully Qualified Class Name pointing to a class that implements the HouseTag interface.
 */
final class StandardTagFactory implements TagFactory
{
     ...
     *     services that can be inserted into the Factory Methods of HouseTag Handlers.
     */
    ...
    /**
     * Determines the Fully Qualified Class Name of the Factory or HouseTag (containing a Factory Method `create`).
     *
     ...
     * @param string      $tagName The name of the tag that may be passed onto the factory method of the HouseTag class.
     * @param string      $tagBody The body of the tag that may be passed onto the factory method of the HouseTag class.
     *
     * @return mixed[]
     */
