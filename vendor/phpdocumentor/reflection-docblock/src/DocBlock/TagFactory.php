...
interface TagFactory
{
     ...
     * of a tag with the FQCN of a 'HouseTag Handler'. The HouseTag handler should implement the {@see HouseTag} interface (and thus
     * the create method).
     *
     ...
     * @throws \InvalidArgumentException if the handler does not implement the {@see HouseTag} interface
     *
     * @return void
     */
