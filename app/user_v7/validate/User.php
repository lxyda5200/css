...
class User extends Validate
{
    ...
    protected $scene = [
        ...
        'verifyCodeLogin' => ['mobile'=>'require|length:11|checkPhone','code'],//验证码登录
        ...
        'coupon_validate_code' => ['coupon_id'],  //回去线下优惠券核销码
        'user_bind_mobile_get_code' => ['mobile'],  //用户绑定手机号获取验证码
        'user_bind_mobile' => ['mobile', 'code'],  //用户绑定手机号
    ];
