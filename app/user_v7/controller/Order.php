...
use app\user_v7\common\Orders;
use app\user_v7\common\StaffLogic;
use app\user_v7\common\UserLogic;
use app\user_v7\model\ProductOrder;
use app\user_v7\model\ProductShouhou as productshouhouModel;
use jiguang\JiG;
use think\Db;
...
//                    'coupon_money' => round(($coupon_money/$store_number)),
            ...
            switch($pay_type){
                case 1:
                    $pay_type = "支付宝";
                    $notify_url = SERVICE_FX."/user_v7/ali_pay/goods_alipay_notify";
                    $aliPay = new AliPay();
                    $data['alipay_order_info'] = $aliPay->appPay($pay_order_no,$pay_money,$notify_url);
                    break;
                case 2:
                    $pay_type = "微信";
                    $notify_url = SERVICE_FX."/user_v7/wx_pay/goods_wxpay_notify";
                    $wxPay = new WxPay();
    ...
    public function Pay(){
        try{
            ...
            switch($pay_type){
                case 1:
                    $pay_type = "支付宝";
                    $notify_url = SERVICE_FX."/user_v7/ali_pay/repay_alipay_notify";
                    $aliPay = new AliPay();
                ...
                case 2:
                    $pay_type = "微信";
                    $notify_url = SERVICE_FX."/user_v7/wx_pay/repay_wxpay_notify";
                    $wxPay = new WxPay();
...
//                ->where('coupon_rule.end_time','gt',$time2)
    ...
    public function maidanOrder(UserValidate $UserValidate){
        ...
        try{
            ...
            switch($pay_type){
                case 'wx':
                    $notify_url = SERVICE_FX."/user_v7/wx_pay/maidan_wxpay_notify";
                    $wxPay = new WxPay();
                    $data['wxpay_order_info'] = $wxPay->getOrderSign($order_sn,$price_maidan,$notify_url);
                    break;
                case 'zfb':
                    $notify_url = SERVICE_FX."/user_v7/ali_pay/maidan_alipay_notify";
                    $aliPay = new AliPay();
