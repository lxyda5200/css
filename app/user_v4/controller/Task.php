        ...
        try{
            ...
            foreach($list as $v){
                ...
                if($v['discount_money'] > 0){
                    ...
                    if($percent == 1){
                        $store_shouru[$v['store_id']] += $v['relpay_money'] + $v['discount_money'];
                    }else{
                        $store_shouru[$v['store_id']] += $v['relpay_money'];
                    }
                    ...
                    if($percent == 1){
                        ...
                        $store_shouru[$v['store_id']] += $v['relpay_money'] - $v['return_money'];
                    }
                }else{
                    $store_shouru[$v['store_id']] += $v['relpay_money'];
                }
                ...
                ##用户实际消费金额
                $user_money[$v['user_id']] += $v['relpay_money'];
