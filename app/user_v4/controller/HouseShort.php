...
use app\user_v4\model\HouseImg;
use app\user_v4\model\HouseTag;
use app\user_v4\model\RoomConfig;
use app\user_v4\model\ShortComment;
use app\user_v4\model\ShortOrder;
use app\user_v4\model\ShortTrafficTag;
