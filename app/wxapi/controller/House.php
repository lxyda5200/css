...
use app\wxapi\model\HouseTag;
use app\wxapi\model\LongOrder;
use app\wxapi\model\RoomConfig;
use app\wxapi\validate\HouseEntrust;
use think\Db;
...
class House extends Base
{
    ...
    public function collection(){
        ...
        $house = \app\user\model\House::get($param['house_id']);
    ...
    public function houseDetail(){
        ...
        $data = \app\user\model\House::getHouseDetail($param['house_id']);
     ...
     * 推荐房源列表
     */
    public function recommendHouseList(){
    ...
    public function orderDetail(){
        ...
        //获取房源信息
        $house_info = \app\user\model\House::with('houseImg')->field('id,title,rent,rent_mode,type,bedroom_number,parlour_number,toilet_number,acreage')->where('id',$data['house_id'])->find();
