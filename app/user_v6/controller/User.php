...
use app\user_v6\common\Login;
use app\user_v6\model\Coupon;
use app\user_v6\model\DrawLottery;
use app\user_v6\model\DrawLotteryUserNum;
use app\user_v6\model\HouseEntrust;
use app\user_v6\validate\Login as LoginValidate;
use app\user_v6\common\Login as LoginFunc;
use app\user_v6\common\User as UserFunc;
use app\user_v6\validate\UserAddress;
use jiguang\JiG;
use my_redis\MRedis;
...
use think\Session;
use app\user_v6\model\User as UserModel;
use app\user_v6\validate\User as UserValidate;
use app\user_v6\validate\UserAddress as UserAddrValidate;
use app\user_v6\model\UserAddress as UserAddrModel;
use app\user_v6\model\House as HouseModel;
use app\user_v6\model\HouseShort as HouseShortModel;
use app\user_v6\model\Store as StoreModel;
use app\user_v6\common\UserLogic;
use app\user_v6\controller\Task as TaskCon;
...
//                    $avatar = DS.'uploads'.DS.$this->request->module().DS.'avatar'.DS.$info->getSaveName();
                    ...
                    JiG::editUserInfo($userInfo['user_id'],1,$web_path . $avatar);
 ...
 * */
    public function store_collection_and_cancel(){
        try{
            //token 验证
            $userInfo = \app\user_v6\common\User::checkToken();
            if ($userInfo instanceof Json){
                return $userInfo;
            }
            $param = $this->request->post();
