...
use app\user_v3\common\Login;
use app\user_v3\model\HouseEntrust;
use app\user_v3\validate\Login as LoginValidate;
use app\user_v3\common\Login as LoginFunc;
use app\user_v3\common\User as UserFunc;
use app\user_v3\validate\UserAddress;
use think\Db;
use think\Exception;
use think\Log;
use think\Request;
...
use think\Session;
use app\user_v3\model\User as UserModel;
use app\user_v3\validate\User as UserValidate;
use app\user_v3\validate\UserAddress as UserAddrValidate;
use app\user_v3\model\UserAddress as UserAddrModel;
use app\user_v3\model\House as HouseModel;
use app\user_v3\model\HouseShort as HouseShortModel;
use app\user_v3\model\Store as StoreModel;
 ...
 * */
    public function store_collection_and_cancel(){
        try{
            //token 验证
            $userInfo = \app\user_v3\common\User::checkToken();
            if ($userInfo instanceof Json){
                return $userInfo;
            }
            $param = $this->request->post();
