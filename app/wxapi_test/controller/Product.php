...
use app\wxapi_test\model\CommentModel;
use app\wxapi_test\model\CommentSupportModel;
use app\wxapi_test\model\GiftpackOrder;
use app\wxapi_test\model\MemberOrder;
use app\wxapi_test\model\Product as Pmodel;
use app\wxapi_test\model\TopicReadModel;
use think\Config;
use think\Db;
...
//            $data = Cache::get('product_'.$product_id.$product_specs);
            ...
            $data['link'] = "http://192.168.124.233/css/public/index.php/wxapi_test/product/productDetail/product_id/{$data['id']}.html";
