...
class Index extends Base
{
    ...
    public function getopenid()
    {
        try {
            ...
            $code=trim($code);
            $userInfo = \app\wxapi_test\common\Weixin::getOpenid($code);
    ...
    public function wxlogin()
    {
        try {
            ...
            $phone_info = \app\wxapi_test\common\Weixin::getUserPhone($user_info['wx_session_key'],$iv,$encryptedData);
//            addErrLog($phone_info);
            ...
            if($ismobile){
                ...
                if($user_id==$ismobile['user_id']){
                    ...
                    if($coupon_number>1){
                        $data['coupon_info']['c_bg']='/uploads/coupon/wxapi_test/2x.png';
                        $data['coupon_info']['b_bg']='/uploads/coupon/wxapi_test/quan.png';
                        $data['coupon_info']['list']=$coupon;
                    }elseif($coupon_number==1){
                        $data['coupon_info']['c_bg']='/uploads/coupon/wxapi_test/1x.png';
                        $data['coupon_info']['b_bg']='/uploads/coupon/wxapi_test/quan.png';
                        $data['coupon_info']['list']=$coupon;
                    }
