...
use app\wxapi_test\model\HouseEntrust;
use app\wxapi_test\model\TagFollowModel;
use app\wxapi_test\model\TopicFollowModel;
use app\wxapi_test\validate\UserAddress;
use app\wxapi_test\validate\User as UserValidate;
...
use think\File;
use app\wxapi_test\common\Images;
use think\Image;
use think\Log;
use think\Request;
use think\response\Json;
use think\Session;
use app\wxapi_test\common\User as UserFunc;
...
//            if($coupon_type == 1 && $coupon_id)$coupon_id = explode(',',$coupon_id);
    ...
    public function addAddress(){
        ...
        $userAddressModel = new \app\wxapi_test\model\UserAddress();
        ...
        try{
            ...
            switch($eventType){
                case 'FileUploadComplete':  //上传成功回调
                    ...
                    if(!isset($param['Extend']) || $param['Extend'] != 1)return false;
