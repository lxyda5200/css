...
use app\user_v2\model\HouseImg;
use app\user_v2\model\HouseTag;
use app\user_v2\model\RoomConfig;
use app\user_v2\model\ShortComment;
use app\user_v2\model\ShortOrder;
use app\user_v2\model\ShortTrafficTag;
