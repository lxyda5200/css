...
class Permissions extends Controller
{
    ...
    protected function _initialize()
    {
        ...
        //得到用户的权限菜单
        //如果是超级管理员 id 1 则默认全部权限/去掉我的门店模块
        if (Session::get('admin_cate_id') == 1) {
            $menus = Db::name('admin_menu')->where('id','neq',708)->column('id');
        } else {
