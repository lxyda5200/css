...
class AliyunVodUploader
{
    ...
    public function uploadLocalVideo($uploadVideoRequest)
    {
        ...
        $res = $this->uploadOssObject($uploadVideoRequest->getFilePath(), $uploadInfo->UploadAddress->FileName, $uploadInfo, $headers);
        return $res;
    }
    ...
    private function uploadOssObject($filePath, $object, $uploadInfo, $headers=null)
    {
        ...
        return ['media_id'=>$uploadInfo->MediaId,'path'=>$bucketHost.'/'.$object];
    }
